...
/**
 * Delegate that implements all Flutter logic that is the same between a {@link ThrioFlutterActivity} and
 ...
 * {@link FlutterFragment} within a {@link ThrioFlutterActivity}.
 *
 ...
 * {@link ThrioFlutterActivity} based on the AOSP {@code Activity}, and an independent {@link
 ...
 * ThrioFlutterActivity} and {@link FlutterFragment} and then eliminated.
 *
 ...
 * otherwise be placed in either {@link ThrioFlutterActivity} or {@link FlutterFragment}, and in exactly
 * the same form. <strong>Do not use this class as a convenient shortcut for any other
 * behavior.</strong>
 */
/* package */ final class ThrioFlutterPageDelegate {
    ...
    // to this ThrioFlutterPageDelegate.
    @NonNull
    private Host host;
    @Nullable
    ...
    ThrioFlutterPageDelegate(@NonNull Host host) {
        this.host = host;
    }

    /**
     * Disconnects this {@code ThrioFlutterPageDelegate} from its host {@code Activity} or
     * {@code Fragment}.
     *
     * <p>No further method invocations may occur on this {@code ThrioFlutterPageDelegate}
...
//                    .attachToActivity(host.getActivity(), host.getLifecycle());
     ...
     *
     * <ol>
     *   <li>creates a new {@link ThrioFlutterView} in a {@code View} hierarchy
     *   <li>adds a {@link FlutterUiDisplayListener} to it
     *   <li>attaches a {@link FlutterEngine} to the new {@link ThrioFlutterView}
    ...
    View onCreateView(
        ...
        if (host.getRenderMode() == RenderMode.surface) {
            ...
            flutterView = new ThrioFlutterView(host.getActivity(), flutterSurfaceView);
        } else {
            ...
            flutterView = new ThrioFlutterView(host.getActivity(), flutterTextureView);
        }

        // Add listener to be notified when Flutter renders its first frame.
        flutterView.addOnFirstFrameRenderedListener(flutterUiDisplayListener);

        flutterSplashView = new ThrioFlutterSplashView(host.getContext());
     ...
     *
     * <p>Reloading/restarting Dart within a given ThrioFlutterView is not supported. If this method is
     ...
     *       lifecycle.
     *   <li>Detaches this delegate's {@link FlutterEngine} from this delegate's {@link ThrioFlutterView}.
     * </ol>
     */
    void onStop() {
        Log.v(TAG, "onStop()");
     ...
     *
     * <p>This method removes this delegate's {@link ThrioFlutterView}'s {@link FlutterUiDisplayListener}.
     */
    void onDestroyView() {
    ...
    private void ensureAlive() {
        if (host == null) {
            throw new IllegalStateException(
                    "Cannot execute method on a destroyed ThrioFlutterPageDelegate.");
        }
    }

    /**
     * The {@link ThrioFlutterActivity} or {@link FlutterFragment} that owns this {@code
     * ThrioFlutterPageDelegate}.
     */
    /* package */ interface Host
        ...
        /**
         * Returns the {@link RenderMode} used by the {@link ThrioFlutterView} that displays the {@link
        ...
        /**
         * Returns the {@link TransparencyMode} used by the {@link ThrioFlutterView} that displays the {@link
         * FlutterEngine}'s content.
         */
        @NonNull
        ...
        /**
         * Returns the {@link FlutterEngine} that should be rendered to a {@link ThrioFlutterView}.
         *
         ...
         * io.flutter.embedding.android.ThrioFlutterView.RenderMode} is set to {@link
         * io.flutter.embedding.android.ThrioFlutterView.RenderMode#surface}. Otherwise, {@link
         ...
         * <p>This method is only invoked if the {@link
         * io.flutter.embedding.android.ThrioFlutterView.RenderMode} is set to {@link
         * io.flutter.embedding.android.ThrioFlutterView.RenderMode#texture}. Otherwise, {@link
        ...
        /**
         * Invoked by this delegate when its {@link ThrioFlutterView} starts painting pixels.
         */
        void onFlutterUiDisplayed();

        /**
         * Invoked by this delegate when its {@link ThrioFlutterView} stops painting pixels.
         */
